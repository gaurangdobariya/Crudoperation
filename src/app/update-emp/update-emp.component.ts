...
export class UpdateEmpComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.eAge = (this.empService.employeeData[this.empService.empSelected].employee_email)
  ...
  update(eid: string, ename: string, esalary: string, eage: string) {
    ...
    if (ename != null && eid != null && eage != null && esalary != null && !isNaN(parseInt(eid, 10)) && !isNaN(parseInt(esalary, 10))) {
      this.err = "";
      // this.empService.updateEmployee(eid,ename,esalary,eage);  
    }
    else {
